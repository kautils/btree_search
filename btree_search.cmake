...
set(${module_name}_common_pref
    #DEBUG_VERBOSE
    MODULE_PREFIX kautil argorithm 
    ...
    DESTINATION_INCLUDE_DIR include/algorithm
...
set(__t ${${module_name}_static_tmain}_2)
add_executable(${__t})
target_sources(${__t} PRIVATE ${CMAKE_CURRENT_LIST_DIR}/unit_test.cc)
target_link_libraries(${__t} PRIVATE ${${module_name}_static})
target_compile_definitions(${__t} PRIVATE ${${module_name}_static_tmain_ppcs}_2)
